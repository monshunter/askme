...
export function CandidatesClient({ initialPage, initialFilters, locale }: { initialPage: CandidatePage; initialFilters: CandidateFilters; locale: Locale }) {
  ...
  return <div className="admin-page">
    <section className="admin-hero compact"><p className="page-kicker">{t("admin.candidates.kicker")}</p><h1>{t("admin.candidates.title")} <span className="title-seal" aria-hidden="true">问候</span></h1><p>{t("admin.candidates.copy")}</p></section>
