...
export function ReviewsClient({ initialPage, initialFilters, locale }: { initialPage: ReviewPage; initialFilters: Filters; locale: Locale }) {
  ...
  return <div className="admin-page">
    <section className="admin-hero compact"><p className="page-kicker">{t("admin.reviews.kicker")}</p><h1>{t("admin.reviews.title")} <span className="title-seal" aria-hidden="true">问候</span></h1><p>{t("admin.reviews.copy")}</p></section>
