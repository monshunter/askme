...
export function AgentsClient({ initialPage, initialFilters, locale }: { initialPage: AgentPage; initialFilters: AgentFilters; locale: Locale }) {
  ...
  return <div className="admin-page">
    <section className="admin-hero compact"><p className="page-kicker">{t("admin.agents.kicker")}</p><h1>{t("admin.agents.title")} <span className="title-seal" aria-hidden="true">问候</span></h1><p>{t("admin.agents.copy")}</p></section>
