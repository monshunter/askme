...
const pages: Record<string, PageSurface> = {
  ...
  "/workspace/knowledge": { role: "candidate", evidence: ["smoke:material-lifecycle", "browser:candidate"], viewports: ["desktop", "mobile"] },
...
const api: Record<string, ApiSurface> = {
  ...
  "/api/agent/preview": { methods: ["GET"], evidence: ["smoke:agent-preview"] },
  "/api/agent/preview/chat": { methods: ["POST"], evidence: ["smoke:agent-preview", "smoke:repository-analysis-runner"] },
  ...
  "/api/knowledge": { methods: ["GET"], evidence: ["smoke:material-lifecycle"] },
  ...
  "/api/public/agents/[slug]/chat": { methods: ["GET", "POST"], evidence: ["smoke:public-chat", "smoke:repository-analysis-runner"] },
  ...
  "/api/public/agents/[slug]/session": { methods: ["POST"], evidence: ["smoke:public-chat"] },
...
const requiredEntrypoints = [
  ...
  "smoke:api-surface", "smoke:auth", "smoke:connect", "smoke:job-lease", "smoke:material-lifecycle", "smoke:agent-preview", "smoke:admin",
